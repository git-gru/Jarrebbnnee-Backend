...
<!--                <li <?php
                ...
                <li <?php
                if (isset($file_name) && ($file_name == 'all_plans.php' )) {
                    echo "class='active'";
                }
                ?>>
                    <a href="all_plans.php"><i class="fa fa-qrcode" style="color: #5bc0de !important;"></i>coupon code</a>
                </li>
                <li <?php
                if (isset($file_name) && ($file_name == 'all_plans.php' )) {
                    echo "class='active'";
                ...
                ?>>
                    <a href="all_plans.php"><i class="fa fa-money" style="color: #5bc0de !important;"></i>Manage vouchers</a>
                </li>
                <li <?php
                if (isset($file_name) && ($file_name == 'all_plans.php' )) {
                    echo "class='active'";
                ...
                ?>>
                    <a href="all_plans.php"><i class="fa fa-money" style="color: #5bc0de !important;"></i>Manage Lottery</a>
                </li>
                <li <?php
